...
public class frmLibro extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Libro ebook=new Libro();
        
        ebook.setIdLibro(Integer.parseInt(jTextField1.getText()));
        ebook.setTitulo(jTextField2.getText());
        ebook.setAutor(jTextField3.getText());
     //   ebook.setEstado(Integer.parseInt(jComboBox1.getSelectedItem()));
        JOptionPane.showMessageDialog(rootPane, ebook.getTitulo());
